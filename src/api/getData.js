...
export const login = data => fetch('/admin/admin/login', data, 'POST');
...
export const adminList = data => fetch('/admin/admin/getAdminList', data);

/**
 * 管理员数量
 */

export const adminCount = () => fetch('/admin/admin/adminCount');
...
export const getUserList = data => fetch('/admin/admin/getAdminList', data);
